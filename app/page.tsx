  ...
  return (
    <main className="px-12 mx-auto">
      ...
      {/* <p className="px-8 mt-12 mb-12 text-lg text-left text-wrap dark:text-white">
        A little about me is I work in tech&sbquo; with a background in software engineering and electrical engineering. I currently work as an Enterprise Architect, however&sbquo; up to this point I&apos;ve spent my career working in the cybersecurity field. 

        My real passion is solving complex problems with tech&sbquo; hence why I spend free time programming! When I&apos;m not working&sbquo; you can usually find me trying to pick up new skills&sbquo; spending time with my friends&sbquo; fiancee&sbquo; or Cleo my french bulldog. Thank you for taking the time to visit my website and hopefully you find something you enjoy in one of my posts.
      </p> */}
      <Posts />
    </main>
  );
